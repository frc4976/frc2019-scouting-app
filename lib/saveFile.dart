...
List<String> titles = List<String>(43);
List<String> row1 = List<String>(43);
List<String> row2 = List<String>(43);
List<String> row3 = List<String>(43);
List<String> row4 = List<String>(43);
List<String> row5 = List<String>(43);
List<String> row6 = List<String>(43);
List<String> row7= List<String>(43);
List<String> row8 = List<String>(43);
List<String> row9 = List<String>(43);
List<String> row10 = List<String>(43);
List<String> row11 = List<String>(43);
List<String> row12 = List<String>(43);
List<String> row13 = List<String>(43);
List<String> row14 = List<String>(43);
List<String> row15 = List<String>(43);
List<String> row16 = List<String>(43);
List<String> row17 = List<String>(43);
List<String> row18 = List<String>(43);
List<String> row19 = List<String>(43);
List<String> row20 = List<String>(43);
...
Future<File> writeFile() async {
  ...
  titles[8] = "First Move";
  titles[9] = "Successful?";
  titles[10] = "Auto Cargo";
  titles[11] = "Auto Hatches";
  titles[12] = "Left Close 3";
  titles[13] = "Left Close 2";
  titles[14] = "Left Close 1";
  titles[15] = "Left Cargo 3";
  titles[16] = "Left Cargo 2";
  titles[17] = "Left Cargo 1";
  titles[18] = "Left Far 3";
  titles[19] = "Left Far 2";
  titles[20] = "Left Far 1";
  titles[21] = "Ship Hatches";
  titles[22] = "Ship Cargo";
  titles[23] = "Right Far 3";
  titles[24] = "Right Far 2";
  titles[25] = "Right Far 1";
  titles[26] = "Right Cargo 3";
  titles[27] = "Right Cargo 2";
  titles[28] = "Right Cargo 1";
  titles[29] = "Right Close 3";
  titles[30] = "Right Close 2";
  titles[31] = "Right Close 1";
  titles[32] = "Breakdown?";
  titles[33] = "Recovered?";
  titles[34] = "Pickup";
  titles[35] = "Self";
  titles[36] = "Supported";
  titles[37] = "Helped 1st bot";
  titles[38] = "Helped 2nd bot";
  titles[39] = "Defense";
  titles[40] = "Foul Points";
  titles[41] = "Red";
  titles[42] = "Yellow";
  titles[43] = "Score";
